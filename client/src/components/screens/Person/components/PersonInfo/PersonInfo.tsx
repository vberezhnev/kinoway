...
export const PersonInfo: FC<PersonInfoProps> = ({ data }) => {
  const { profession, growth, sex, birthday, spouses, movies, death } = {
    ...data,
  };
  ...
  const items = [
    ...
    { caption: "Рост", value: `${growth} см`, condition: growth },
    {
      ...
      value: birthday, //convertTimestampToDate(birthday, 'D MMMM YYYY')
      condition: birthday,
    },
    {
      caption: "Дата смерти",
      value: death, // convertTimestampToDate(death, 'D MMMM YYYY')
      condition: death,
    },
