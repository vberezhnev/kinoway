...
import { useSettingsStore } from "./defaultSettings";
                ...
                <Stack spacing={1}>
                    <div>
                        ...
                        <Slider
                            ...
                            step={1}
                            onChange={(_, value) =>
                                settings.update({ snowflakeCount: value as number })
                            }
                        />
                    </div>
                    <div>
                        ...
                        <Slider
                            ...
                            step={0.5}
                            onChange={(_, value) =>
                                settings.update({ speed: value as [number, number] })
                            }
                        />
                    </div>
                    <div>
                        ...
                        <Slider
                            ...
                            step={0.5}
                            onChange={(_, value) =>
                                settings.update({ wind: value as [number, number] })
                            }
                        />
                    </div>
                    <div>
                        ...
                        <Slider
                            ...
                            step={0.5}
                            onChange={(_, value) =>
                                settings.update({ radius: value as [number, number] })
                            }
                        />
                    </div>
                    {settings.useImages ? (
                        <div>
                            <Typography gutterBottom>
                                Rotation Speed{" "}
                                <ValueChip label={`Min ${settings?.rotationSpeed?.[0]}`} />
                        ...
                        <Box my={2}>
                            ...
                            <CirclePicker
                                ...
                                onChangeComplete={(value) =>
                                    settings.update({ color: value.hex })
                                }
                            />
                        </Box>
                    )}
