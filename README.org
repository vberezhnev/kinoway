...
8) [ ] Create 404 page
9) [X] Create component to provide ~data~ on it. Like ~<Content data={data} loading={isLoading} error={isError} />~
10) [X] Fix "NaN" mark of film in SearchResults component
11) [X] Fix "NaN" mark of film in SimilarMovies component
12) [X] Fix "Similar movies" component
13) [X] Add "Watch later" button (component)
14) [ ] Fix footer on film search page
15) [ ] Optimize film page opening
16) [ ] Redesign main page
17) [-] Replace localstorage in theme state with redux
